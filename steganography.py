...
import hashlib
#  the cover image
cover_image_path = r"C:\Users\project\pic2.jpg"
img1 = cv2.imread(cover_image_path)
img1 = cv2.imread(cover_image_path)
if img1 is None:
    print("Image not found. check the file path and make sure the image exists")
    exit()
# the image you want to hide in the above image
secret_image_path = r"C:\Users\project\pic1.jpg"
...
output_image_path = r"C:\Users\project\encrpt_img.jpg"
